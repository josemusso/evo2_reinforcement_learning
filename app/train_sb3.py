...
#variables Globales
model_to_use = A2C #modelo a entrenar
...
def main(args):
  ...
  model.learn(total_timesteps=timesteps_to_train, reset_num_timesteps = False, tb_log_name="tb", callback=eval_callback, progress_bar=True)

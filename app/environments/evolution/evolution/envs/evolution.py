...
#from premes_csv_to_json_randomizer import premes_csv_to_json
...
#se genera init assessment random
premes_csv_to_json('./environments/evolution/evolution/envs/assessments.csv')
...
assestment_json = './environments/evolution/evolution/envs/random_initial_assesment.json' #se carga assessment random generado
    ...
    def reset(self):
        ...
        if self.env_test == False:
            if use_custom_assestment == True:
                ...
                effects = assestment['pr_initial_assessment']["effects"]
                for effect in effects:
                    if effect["operator"] == "set":
